...
export default function BrainRotCustomizer() {
  ...
  const voiceOptions = [
    ...
    {
      id: "4fR9T2GP0lKJMKFlL9md",
      name: "Duke Dennis",
      accent: "American",
      gender: "Male",
      personality: "Zaddy Vibes",
    },
  ];
