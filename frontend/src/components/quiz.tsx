        ...
        <div className="relative z-10 p-6">
            ...
            <div className="bg-white/90 backdrop-blur-md rounded-2xl p-4 shadow-xl">
                ...
                <div className="flex items-center space-x-4">
                    ...
                    <div>
                     <h2 className="text-2xl md:text-3xl font-bold text-gray-800 leading-relaxed">Quiz</h2>
            ...
            <div className="bg-white/95 backdrop-blur-md rounded-3xl p-8 shadow-2xl">
                ...
                {/* Question */}
                <div className="mb-8">
                <h2 className="text-2xl md:text-2xl font-semibold text-gray-800 leading-relaxed">{currentQ.question}</h2>
                </div>
